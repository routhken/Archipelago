...
3. Download the lua51.dll file from Heinermann and place it in the install directory. The file is pinned in the Grim Dawn thread in the Archipelago Discord.
