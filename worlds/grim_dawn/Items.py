...
_item_data_list: list[tuple[str,ItemClassification,int,int,Optional[Callable[[MultiWorld, int], bool]]]] = [
    ...
    ("Valley of the Chosen Destroy Barrier",                ItemClassification.progression,                  220062,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1) and (multiworld.worlds[player].options.dlc_fg.value == 1) and ((multiworld.worlds[player].options.forbidden_dungeons.value == 1))),
