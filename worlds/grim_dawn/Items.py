...
_item_data_list: list[tuple[str,ItemClassification,int,int,Optional[Callable[[MultiWorld, int], bool]]]] = [
    ...
    ("Malmouth Bridge Lowered",                             ItemClassification.progression,                  220019,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 4)),
    ...
    ("Devil's Crossing Revered",                            ItemClassification.progression,                  220066,                       1,                            None),
    ("Rovers Revered",                                      ItemClassification.progression,                  220067,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 2)),
    ("Death's Vigil - Kymon's Chosen Revered",              ItemClassification.progression,                  220068,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 3)),
    ("Black Legion Revered",                                ItemClassification.progression,                  220069,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 3)),
    ("Coven of Ugdenbog Revered",                           ItemClassification.progression,                  220070,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 4)),
    ("Malmouth Resistance Revered",                         ItemClassification.progression,                  220071,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 4)),
    ("Witch God Cults Revered",                             ItemClassification.useful,                       220072,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1)),
]
