...
_item_data_list: list[tuple[str,ItemClassification,int,int,Optional[Callable[[MultiWorld, int], bool]]]] = [
    ...
    ("Skeleton Keys",                                       ItemClassification.useful,                       220059,                       5,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 2 and multiworld.worlds[player].options.forbidden_dungeons.value == 1)),
    ("Forbidden Door Unlock",                               ItemClassification.progression,                  220060,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 2 and multiworld.worlds[player].options.forbidden_dungeons.value == 1)),
    ("Vanguard of the Three Door Unlock",                   ItemClassification.progression,                  220061,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1)),
    ("Valley of the Chosen Destroy Barrier",                ItemClassification.progression,                  220062,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1)),
    ("Path of Ascension Destroy Barrier",                   ItemClassification.progression,                  220063,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1)),
    ("Eldritch Gate Destroy Barrier",                       ItemClassification.progression,                  220064,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1)),
    ("Tomb of Nephos Destroy Barrier",                      ItemClassification.progression,                  220065,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1)),
    ("Ruins of Abyd Open Portal",                           ItemClassification.progression,                  220066,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1)),
    ("Devil's Crossing Revered",                            ItemClassification.progression,                  220067,                       1,                            None),
    ("Rovers Revered",                                      ItemClassification.progression,                  220068,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 2)),
    ("Homestead Revered",                                   ItemClassification.progression,                  220069,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 3)),
    ("Death's Vigil - Kymon's Chosen Revered",              ItemClassification.progression,                  220070,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 3)),
    ("Black Legion Revered",                                ItemClassification.progression,                  220071,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 3)),
    ("Coven of Ugdenbog Revered",                           ItemClassification.progression,                  220072,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 4)),
    ("Malmouth Resistance Revered",                         ItemClassification.progression,                  220073,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 4)),
    ("Witch God Cults Revered",                             ItemClassification.useful,                       220074,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1)),
]
