...
item_data_table: Dict[str, GrimDawnItemData] = {
    ...
    "Calamity":                                 GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Ruination":                                GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Equilibrium":                              GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Glacier":                                  GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Squall":                                   GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Inferno":                                  GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Corruption":                               GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Sanctuary":                                GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Guile":                                    GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Rampage":                                  GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Mistborne Talisman":                       GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Bladesworn Talisman":                      GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
    "Gunslinger Talisman":                      GrimDawnItemData( code=baseId+22, type=ItemClassification.useful, can_create=lambda multiworld, player: False),
