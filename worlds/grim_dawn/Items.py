...
_item_data_list: list[tuple[str,ItemClassification,int,int,Optional[Callable[[MultiWorld, int], bool]]]] = [
    ...
    ("Tomb of Nephos Destroy Barrier",                      ItemClassification.progression,                  220065,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1) and (multiworld.worlds[player].options.dlc_fg.value == 1) and ((multiworld.worlds[player].options.faction.value == 1))),
    ...
    ("Witch God Cults Revered",                             ItemClassification.progression,                  220074,                       1,                            lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 1) and (multiworld.worlds[player].options.dlc_fg.value == 1)),
]
