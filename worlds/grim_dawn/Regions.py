...
region_data_table: Dict[str, GrimDawnRegionData] = {
    ...
    "Act 3":                    GrimDawnRegionData(connecting_regions=["Steps of Torment","Port Valbury","Four Hills Secret","Tyrant's Hold","Homestead Side Doors","Act 4","Act 7"],can_create=lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 2)),
    ...
    "Act 5":                    GrimDawnRegionData(connecting_regions=["Act 6"],can_create=lambda multiworld, player: (multiworld.worlds[player].options.goal.value >= 3)),
