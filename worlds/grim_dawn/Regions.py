...
region_data_table: Dict[str, GrimDawnRegionData] = {
    ...
    "Act 1":                GrimDawnRegionData(connecting_regions=["Sunken Reliquary","East Marsh","Act 2","Devil's Aquifer","Warden's Cellar","Act 7"]),
    ...
    "Act 3":                GrimDawnRegionData(connecting_regions=["Port Valbury","Four Hills Secret","Tyrant's Hold","Homestead Side Doors","Act 4"]),
    ...
    "Act 5":                GrimDawnRegionData(connecting_regions=["Act 6"]),
    ...
    "Act 7":                GrimDawnRegionData(connecting_regions=["Nane's Hideout","Ancient Grove","Forlorn Cellar","Act 8"]),
    ...
    "Act 8":                GrimDawnRegionData(connecting_regions=["Act 9"]),
    "Act 9":                GrimDawnRegionData(connecting_regions=["Harbor Stash","Crown Hill"]),
