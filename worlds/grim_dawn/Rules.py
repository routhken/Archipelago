...
class GrimDawnRules:
    ...
    def __init__(self, world: GrimDawnWorld) -> None:
        ...
        self.location_rules = {
            ...
            "Rescue Garett Torvan":                             lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Convince Ulgrim":                                  lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Steelcap District Riftgate Secured":               lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            ...
            "Council Report to Theodin Marcell":                lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "The Hidden Path - Bysmiel":                        lambda state: state.has("Lower Crossing Destroy Blockade",self.player),
            "Journal of Inquisitor Creed - 9th Entry":          lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Clippings from Ivonda's Memory":                   lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            ...
            "The Coven's Walls":                                lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Pruning The Weeds":                                lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Allure of the Wendigo":                            lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Trapped Wraith 1":                                 lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Trapped Wraith 2":                                 lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Trapped Wraith 3":                                 lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Power in the Circles":                             lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Stone Basilisk":                                   lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Final Seal":                                       lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Galakros, the Mountain":                           lambda state: state.has("Malmouth Sewers Destroy Blockade",self.player),
            "Someone on the Inside":                            lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Bring out Your Dead":                              lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Secure the Blackiron Docks":                       lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Rise of the Insurgence":                           lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Alberran Rein":                                    lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Dreven Cole":                                      lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            "Cyrian Marcan":                                    lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
            ...
            "Chamber of the High Council Secret Chest":         lambda state: state.can_reach_location("Warden Krieg",self.player) and state.can_reach_location("The Amalgamation",self.player) and state.can_reach_location("The Loghorrean",self.player),
