...
class GrimDawnRules:
    ...
    def __init__(self, world: GrimDawnWorld) -> None:
        ...
        self.location_rules = {
            ...
            "Rescue Garett Torvan":                             lambda state: state.has_all(["Warden Boss Door Unlock","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Convince Ulgrim":                                  lambda state: state.has_all(["Warden Boss Door Unlock","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Steelcap District Riftgate Secured":               lambda state: state.has_all(["Warden Boss Door Unlock","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            ...
            "Council Report to Theodin Marcell":                lambda state: state.has_all(["Warden Boss Door Unlock","Malmouth Resistance Revered","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            ...
            "The Coven's Walls":                                lambda state: state.has_all(["Warden Boss Door Unlock","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Pruning The Weeds":                                lambda state: state.has_all(["Warden Boss Door Unlock","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Allure of the Wendigo":                            lambda state: state.has_all(["Warden Boss Door Unlock","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Trapped Wraith 1":                                 lambda state: state.has_all(["Warden Boss Door Unlock","Coven of Ugdenbog Revered","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Trapped Wraith 2":                                 lambda state: state.has_all(["Warden Boss Door Unlock","Coven of Ugdenbog Revered","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Trapped Wraith 3":                                 lambda state: state.has_all(["Warden Boss Door Unlock","Coven of Ugdenbog Revered","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Power in the Circles":                             lambda state: state.has_all(["Warden Boss Door Unlock","Coven of Ugdenbog Revered","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Stone Basilisk":                                   lambda state: state.has_all(["Warden Boss Door Unlock","Coven of Ugdenbog Revered","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Final Seal":                                       lambda state: state.has_all(["Warden Boss Door Unlock","Coven of Ugdenbog Revered","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Galakros, the Mountain":                           lambda state: state.has("Malmouth Sewers Destroy Blockade",self.player),
            "Someone on the Inside":                            lambda state: state.has_all(["Warden Boss Door Unlock","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            ...
            "Journal of Inquisitor Creed - 10th Entry":         lambda state: state.has_all(["Warden Boss Door Unlock","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
            "Nearan's Work Log":                                lambda state: state.has_all(["Warden Boss Door Unlock","Malmouth Resistance Revered","Homestead Main Doors Unlock","Fort Ikon Gate Unlock","Fort Ikon Destroy Blockade","Tomb of the Watchers Door Unlock","Loghorrean Seal Unlock","Homestead Side Doors Unlock"],self.player),
