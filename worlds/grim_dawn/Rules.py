...
class GrimDawnRules:
    ...
    def __init__(self, world: GrimDawnWorld) -> None:
        ...
        self.location_rules = {
            ...
            "Onarix, the Razorhide":                            lambda state: state.has("Ruins of Abyd Open Portal",self.player),
            "Inarah, the Afflicted":                            lambda state: state.has("Tomb of Nephos Destroy Barrier",self.player),
            "Lost Tomb of the Damned Secret Chest":             lambda state: state.has("Ruins of Abyd Open Portal",self.player),
            ...
            "Making a Deal":                                    lambda state: state.has_all(["Homestead Revered","Warden Boss Door Unlock"],self.player),
